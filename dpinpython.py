# 元記事(http://wakabame.hatenablog.com/entry/2017/09/10/211428 )
# 元記事の元記事(https://qiita.com/drken/items/a5e6fe22863b7992efdb )
N = 1
...
def knapsack(N, W, weight, value):
    # ナップサック問題( N 個の荷物を重さが W 以下になるように詰め込むとき価値の和を最大化)
...
def restricted_part_sum_an(a, m, A):
